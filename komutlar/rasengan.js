...
var prefix = ayarlar.prefix;
 ...
 if (!message.guild.member(user).bannable) return message.channel.send(`Bu kişiyi sunucudan yasaklayamıyorum çünkü \`benden daha yüksek bir role sahip\` ya da \`bana gerekli yetkileri vermedin\`.`);
  ...
  .setColor('RANDOM')
  .addField('Bilgiler:', `
  **\nYok olan Hain Ninja :<@${user.id}>** 
  **\nRasenganı Yediğin Hokage:@${message.author.tag}**
  **\nRasengan Sebebi:${reason}\**
  `)
  .setImage('https://cdn.discordapp.com/attachments/680825030627688459/835505808309485639/ClassicFeistyElectriceel-max-1mb.gif')
...
exports.help = {
  ...
  usage: 'rasengan <@kullanıcı> <sebep>',
